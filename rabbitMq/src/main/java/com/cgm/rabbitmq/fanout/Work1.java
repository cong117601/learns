...
public class Work1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //绑定交换机与队列
        channel.queueBind(RabbitMqConst.QUEUE_FANOUT_LOG_1, RabbitMqConst.EXCHANGE_NAME, "");
        ...
        channel.basicConsume(RabbitMqConst.QUEUE_FANOUT_LOG_1, true, deliverCallback, consumerTag -> {
        });
